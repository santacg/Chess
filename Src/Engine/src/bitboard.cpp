...
#define WHITE_KNIGHTS_BB 2
#define BLACK_KNIGHTS_BB 3

#define WHITE_BISHOPS_BB 4
#define BLACK_BISHOPS_BB 5

#define WHITE_ROOKS_BB 6
#define BLACK_ROOKS_BB 7
...
vector<Move> Bitboard::getMoveHistory() { return moveHistory; }

bitset<64> *Bitboard::getPieces() { return piecesBB; }
...
void Bitboard::unmakeMove() { return; }

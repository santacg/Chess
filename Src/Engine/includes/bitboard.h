...
public:
  ...
  /**
   * Returns a vector containing the moveHistory member
   *
   * @return moveHistory member as a vector type
   */
  ...
  /**
   * unmakes the previous move of the position
   *
   * @param a Move type object representing the previous move to be
   * unmade
   */
  void unmakeMove();

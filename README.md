...
The design follows object-oriented programming (OOP) principles for caºlear structure and maintainability, and supports universal chess interface (UCI) for move input.
